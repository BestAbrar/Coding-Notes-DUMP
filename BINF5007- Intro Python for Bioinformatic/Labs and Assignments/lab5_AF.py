...
DNA_seq = ""
while (True):
    print("Please enter DNA seq (press enter to exit)")
    DNA_seq = str(input())
    if (DNA_seq == ""):
        break
    print("The transcribed sequence for "+DNA_seq +" is:"+ transcribe_dna_to_rna(DNA_seq))
    print("The translated sequence for "+DNA_seq +" is:"+ translate_rna_to_protein(transcribe_dna_to_rna(DNA_seq), CODON_TABLE))
...
assert transcribe_dna_to_rna(DNA_seq2)=="AUGUACUACCCUGGGUACAUCGUC" #amino acid is not truncated prematurely due to stop codon (transcribed correctly and redundant)
